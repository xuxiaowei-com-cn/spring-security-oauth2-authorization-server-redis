...
<div align="center" style="text-align: center;">
  ...
  <a target="_blank" href="https://github.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="GitHub stars" src="https://img.shields.io/github/stars/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis?logo=github">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="GitHub forks" src="https://img.shields.io/github/forks/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis?logo=github">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="GitHub watchers" src="https://img.shields.io/github/watchers/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis?logo=github">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
  </a>

  <a target="_blank" href="https://gitee.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="码云Gitee stars" src="https://gitee.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis/badge/star.svg?theme=blue">
  </a>

  <a target="_blank" href="https://gitee.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="码云Gitee forks" src="https://gitee.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis/badge/fork.svg?theme=blue">
  </a>

  <a target="_blank" href="https://gitlab.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="Gitlab stars" src="https://badgen.net/gitlab/stars/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis?icon=gitlab">
  </a>

  <a target="_blank" href="https://gitlab.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="Gitlab forks" src="https://badgen.net/gitlab/forks/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis?icon=gitlab">
  </a>

  <a target="_blank" href="https://gitlab.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="OSCS Status" src="https://www.oscs1024.com/platform/badge/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis.svg?size=small">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
    <img alt="total lines" src="https://tokei.rs/b1/github/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis">
  </a>
...
git remote add framagit https://framagit.org/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis.git
...
[![Stargazers over time](https://starchart.cc/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis.svg)](https://starchart.cc/xuxiaowei-com-cn/spring-security-oauth2-authorization-server-redis)
