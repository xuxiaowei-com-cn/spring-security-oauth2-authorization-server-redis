 ...
 */
@Configuration
public class RedisOAuth2AuthorizationServiceConfiguration {

	public static final String REDIS_CACHE_MANAGER_BEAN_NAME = "redisCacheManagerRedisOAuth2AuthorizationService";

	public static final String REDIS_TEMPLATE_BEAN_NAME = "redisTemplateRedisOAuth2AuthorizationService";
	...
	public RedisCacheManager redisCacheManagerRedisOAuth2AuthorizationService(
			@Qualifier(REDIS_TEMPLATE_BEAN_NAME) RedisTemplate<String, OAuth2Authorization> redisTemplate) {
	...
	public RedisTemplate<String, OAuth2Authorization> redisTemplateRedisOAuth2AuthorizationService(
